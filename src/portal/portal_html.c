...
static const char default_html[] =
	...
	"<div class=\"card\"><h2><span class=\"dot\" id=\"d4\"></span>Anemometro &mdash; Viento</h2>"
	"<div class=\"grid\">"
	"<div class=\"kv\"><span>Velocidad</span><b><span id=\"ws\">--</span> m/s</b></div>"
	"<div class=\"kv\"><span>Direccion</span><b><span id=\"wd\">--</span> &deg;</b></div></div>"
	"<div class=\"lbl\">Velocidad m/s (historico)</div>"
	"<svg class=\"spark\" id=\"spws\" viewBox=\"0 0 240 40\" preserveAspectRatio=\"none\"></svg></div>"
	"</div><footer>Portal cautivo &middot; http://192.168.4.1</footer>"
	"<script>"
	"var H={t:[],co:[],pm:[],voc:[],ws:[]};"
	...
	"D('d1',d.bm688);D('d2',d.co);D('d3',d.sen65);D('d4',d.wind);"
